...
shaka.offline.Storage.prototype.filterManifest_ = async function(
  ...
  const preferredVideoCodecs = this.config_.preferredVideoCodecs;
  const preferredAudioCodecs = this.config_.preferredAudioCodecs;

// eslint-disable-next-line max-len
  shaka.util.StreamUtils.chooseCodecsAndFilterManifest(manifest, preferredVideoCodecs, preferredAudioCodecs, preferredAudioChannelCount);
 ...
 * expected by |configure|. This function should be removed in v3.0 when
